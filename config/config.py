...
BOT_TOKEN = environ.get("BOT_TOKEN", "5602474043:AAHrItN1WTu50zivGl2MBW6qeutYA8KuTnE")
...
SUDO_USERS_ID = [int(x) for x in environ.get("SUDO_USERS_ID", "5514111111").split()]
...
F_SUB_CHANNEL = environ.get("acobot_Team")
